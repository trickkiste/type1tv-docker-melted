...
RUN apt-get update && apt-get install -y libmp3lame0 libgavl1 libsamplerate0 libsoxr-lsr0 libxml2 libjack0 libsox2 libsdl1.2debian libgdk-pixbuf2.0-0 liboil0.3 libsoup2.4-1 libqt4-opengl libqt4-svg libqtgui4 libexif12 libtheora0 libvdpau1 libvorbis0a libvorbisenc2 libvorbisfile3 libxcb-shm0 && rm -rf /var/lib/apt/lists/* && apt-get -y remove manpages && apt-get -y autoclean && apt-get -y clean && apt-get -y autoremove
